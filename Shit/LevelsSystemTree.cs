    ...
    public partial class LevelsSystemTree
    {
        ...
        public class LevelInfo
        {
            ...
            public bool Modify(Bonuses NewBonuses, int count = 1)
            {
                ...
                bonuses.DrawStaminaDrain += NewBonuses.DrawStaminaDrain * count;
                bonuses.DrawDrurationMin += NewBonuses.DrawDrurationMin * count;
        ...
        public class Bonuses
        {
            ...
            public float DrawStaminaDrain = 0;
            public float DrawDrurationMin = 0;
